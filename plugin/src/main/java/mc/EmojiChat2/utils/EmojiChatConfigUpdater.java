...
public class EmojiChatConfigUpdater {
	 ...
	 */
	public EmojiChatConfigUpdater(EmojiChat2 plugin) {
	 ...
	 */
	private void updateConfig(EmojiChat2 plugin, FileConfiguration config, int configVersion) {
		// Config v1 & v2 values
		...
		boolean downloadResourcePack = config.getBoolean("download-resourcepack");
		String ResourcePack = config.getString("ResourcePack-Location");
		...
		configLines.add("");
		configLines.add("ResourcePack-Location: " + ResourcePack);
		configLines.add("");
	 ...
	 */
	private void setConfig(EmojiChat2 plugin, List<String> configLines) {
		try {
